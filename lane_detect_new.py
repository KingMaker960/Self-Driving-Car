    ...
    if ret:
        ...
        for line in lines:
            ...
            try:
                ...
                ig = cv2.line(birds_eye, (640, 300),
                              (x2_mid, 420), (0, 0, 255), 2)

                # create straight pipe line in middle of the frame
                x_1, x_2 = 640, 640
                y_1, y_2 = 300, 420
                cv2.line(birds_eye, (x_1, y_1),
                         (x_2, y_2), (0, 0, 255), 2)
                cv2.imshow('ig', ig)
                ...
                radian = np.arctan2(point_2[1] - point_1[1], point_2[0] - point_1[0]) - np.arctan2(
                    point_3[1] - point_1[1], point_3[0] - point_1[0])
                ...
                if angle < -30:
                    cv2.putText(
                        frame, "LEFT", (15, 35), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2, cv2.LINE_AA)
                elif angle > 25:
                    cv2.putText(frame, "RIGHT", (1150, 35),
        ...
        drawing_pts = np.array(
            [[[550, 440], [690, 440], [1000, 640], [200, 640]]], np.int32)
        cv2.polylines(frame, [drawing_pts], True, (0, 0, 255), 3)
